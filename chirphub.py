...
def home():
    ...
    for index, post in posts.iterrows():
        posts.at[index, 'title'] = User.Post.censor_taboo_words(post['title'])
        posts.at[index, 'content'] = User.Post.censor_taboo_words(
            post['content'])
        posts.at[index, 'keywords'] = User.Post.censor_taboo_words(
            post['keywords'])
